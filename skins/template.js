/*
    ...
    A skin consist of 3 main components:

    - a html template with the structue
    - attached event handler for the controls
    - optional: a visual skin through additional CSS files
